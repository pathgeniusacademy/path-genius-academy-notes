...
-- Safe to run after the initial SETUP-PATH-GENIUS-NOTES.sql.
...
-- Intentionally no client policies. Only the service-role inside Notes Edge Functions may use this table.
